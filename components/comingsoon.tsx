		...
		<div className='min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900'>
			...
			<section className='container mx-auto px-6 py-16 text-center'>
				<div className='max-w-4xl mx-auto'>
					...
					<p className='text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed'>
						Easy Dev Service Provider is launching soon with cutting-edge development solutions that will transform your
						digital presence.
					</p>
			...
			<section className='container mx-auto px-6 py-16'>
				<div className='text-center mb-16'>
					<h2 className='text-4xl font-bold text-white mb-4'>What We&apos;ll Offer</h2>
					<p className='text-gray-300 text-lg max-w-2xl mx-auto'>
						Professional development services designed to accelerate your business growth
					</p>
				</div>
