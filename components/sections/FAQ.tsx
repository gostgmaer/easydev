	...
	return (
		<section className='py-20 bg-white'>
			<div className='container mx-auto px-6'>
				...
				<div className='max-w-3xl mx-auto space-y-12'>
					{faq.categories.map((categorySection) => (
						<div key={categorySection.category}>
							<h3 className='text-2xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-primary/30'>
							...
							<div className='space-y-4'>
								{categorySection.questions.map((item, index) => {
									...
									return (
										<div
											key={itemKey}
											className='bg-gray-50 border border-gray-200 rounded-lg overflow-hidden hover:border-primary/50 transition-colors duration-200'>
											<button
												...
												<ChevronDown
													className={`w-5 h-5 text-primary flex-shrink-0 transition-transform duration-300 ${openIndex === itemKey ? "transform rotate-180" : ""
														}`}
												/>
											</button>
				...
				{/* Contact CTA */}
				<div className='mt-16 text-center bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-8 border border-primary/20'>
					...
					<a
						href='#contact'
						className='inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-3 px-8 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg'>
						Contact Us
					</a>
				</div>
			</div>
