...
export default function Contact() {
  ...
  const handleProjectDetailsSelectChange = (
    ...
    try {
      ...
      const payload = {
        ...
        projectDetails: {
          ...
          timelinePreference:
            formData.projectDetails.timelinePreference || "Flexible",
        },
        message: {
          subject: formData.message.subject || "New Inquiry",
